    ...
    <div className="flex flex-col gap-4 sm:gap-6 max-w-6xl mx-auto">
      ...
      */}
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        {/* 🟢 คำแนะนำเลื่อนตาราง: แสดงเฉพาะจอเล็ก และเฉพาะตารางที่มีคอลัมน์เยอะ (stock/import) */}
        {(activeTab === "stock" || activeTab === "import") && !loading && items.length > 0 && (
          <div className="sm:hidden text-[11px] text-gray-400 px-3 pt-2 flex items-center gap-1">
            <span>ເລື່ອນຊ້າຍ-ຂວາເພື່ອເບິ່ງຂໍ້ມູນເພີ່ມ</span>
